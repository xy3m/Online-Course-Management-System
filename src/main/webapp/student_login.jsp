...
<c:remove var="teacherObj" scope="session" />
    ...
    <div class="min-h-[85vh] flex items-center justify-center px-4">
        <div class="glass-card w-full max-w-md p-8 animate-fade-in-up">
            <div class="text-center mb-6">
                <i class="fa-solid fa-user-graduate text-4xl text-brand mb-2"></i>
            ...
            <form action="studentLogin" method="post" class="space-y-6">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Email Address</label>
                    <input required name="email" type="email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand focus:border-transparent outline-none transition" placeholder="you@example.com">
                </div>
                <div>
            ...
            <p class="mt-6 text-center text-sm text-gray-600">
                Don't have an account? <a href="signup.jsp" class="text-brand font-semibold hover:underline">Create one</a>
            </p>
        </div>
    </div>
