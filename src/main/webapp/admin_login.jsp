    ...
    <div class="min-h-[85vh] flex items-center justify-center px-4">
        <div class="glass-card w-full max-w-md p-8 animate-fade-in-up">
            <div class="text-center mb-6">
                <i class="fa-solid fa-user-shield text-4xl text-brand mb-2"></i>
            ...
            <form action="adminLogin" method="post" class="space-y-6">
                <div>
                    ...
                    <input required name="email" type="email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand focus:border-transparent outline-none transition" placeholder="admin@gmail.com">
                </div>
                <div>
